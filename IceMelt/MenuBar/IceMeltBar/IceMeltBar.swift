...
// MARK: - IceMeltBarPanel

final class IceMeltBarPanel: NSPanel {
    /// The shared app state.
    private weak var appState: AppState?

    /// Manager for the IceMelt Bar's color.
    private let colorManager = IceMeltBarColorManager()
    ...
    private func updateOrigin(for screen: NSScreen) {
        ...
        func getOrigin(for iceMeltBarLocation: IceMeltBarLocation) -> CGPoint {
            ...
            case .dynamic:
                ...
                return getOrigin(for: .iceMeltIcon)
            case .mousePointer:
        ...
        setFrameOrigin(getOrigin(for: appState.settings.general.iceMeltBarLocation))
    }
    ...
    func show(section: MenuBarSection.Name, on screen: NSScreen) async {
        ...
        do {
            ...
            Logger.default.error("Cache update failed when showing IceMeltBarPanel - \(error)")
        }

        contentView = IceMeltBarHostingView(
            appState: appState,
...
// MARK: - IceMeltBarHostingView

private final class IceMeltBarHostingView: NSHostingView<IceMeltBarContentView> {
    ...
    @available(*, unavailable)
    required init(rootView: IceMeltBarContentView) {
...
// MARK: - IceMeltBarContentView

private struct IceMeltBarContentView: View {
    @ObservedObject var appState: AppState
    @ObservedObject var colorManager: IceMeltBarColorManager
    ...
    private var content: some View {
        ...
        // IceMelt Bar — the image cache falls back to app icons.
...
// MARK: - IceMeltBarItemView

private struct IceMeltBarItemView: View {
    @ObservedObject var imageCache: MenuBarItemImageCache
    @ObservedObject var itemManager: MenuBarItemManager
    @ObservedObject var menuBarManager: MenuBarManager
...
// MARK: - IceMeltBarItemClickView

private struct IceMeltBarItemClickView: NSViewRepresentable {
