...
final class AppState: ObservableObject {
    ...
    func publisherForWindow(_ id: IceMeltWindowIdentifier) -> some Publisher<NSWindow?, Never> {
    ...
    func openWindow(_ id: IceMeltWindowIdentifier) {
    ...
    func dismissWindow(_ id: IceMeltWindowIdentifier) {
        // Async prevents conflicts with SwiftUI.
        DispatchQueue.main.async {
