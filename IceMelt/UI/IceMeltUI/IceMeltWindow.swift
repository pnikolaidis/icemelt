...
/// A custom scene representing one of IceMelt's windows.
struct IceMeltWindow<Content: View>: Scene {
    @Environment(\.openWindow) private var openWindow
    @Environment(\.dismissWindow) private var dismissWindow

    /// The window's identifier.
    let id: IceMeltWindowIdentifier
    ...
    init(id: IceMeltWindowIdentifier, @ViewBuilder content: () -> Content) {
        self.id = id
...
// MARK: - IceMeltWindowIdentifier

/// Custom identifier constants uses to create IceMelt's windows.
enum IceMeltWindowIdentifier: String, Sendable, CustomStringConvertible {
    /// The identifier for IceMelt's main settings window.
    case settings = "SettingsWindow"

    /// The identifier for IceMelt's permissions window.
...
extension OpenWindowAction {
    ...
    ///
    /// - Parameter id: An identifier for one of IceMelt's windows.
    func callAsFunction(id: IceMeltWindowIdentifier) {
