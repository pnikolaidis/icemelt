...
struct IceMeltGradientPicker<Label: View>: View {
    @Binding private var gradient: IceMeltGradient
    ...
    init(
        gradient: Binding<IceMeltGradient>,
...
private struct IceMeltGradientPickerRoot: View {
    @Environment(\.isEnabled) private var isEnabled

    @Binding var gradient: IceMeltGradient
    ...
    private func gradientChanged(from oldValue: IceMeltGradient, to newValue: IceMeltGradient) {
...
private struct IceMeltGradientPickerHandle: View {
    @Binding var gradient: IceMeltGradient
    @Binding var selection: Int?
    ...
    private var stop: IceMeltGradient.ColorStop? {
