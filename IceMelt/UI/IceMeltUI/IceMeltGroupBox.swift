//
//  IceMeltGroupBox.swift
//  IceMelt
//

import SwiftUI

struct IceMeltGroupBox<Header: View, Content: View, Footer: View>: View {
    ...
    init(
        padding: EdgeInsets = .iceMeltGroupBoxDefaultPadding,
...
extension EdgeInsets {
    /// The default padding for an ``IceMeltGroupBox``.
    static let iceMeltGroupBoxDefaultPadding = EdgeInsets(all: 12)
}
