...
struct AdvancedSettingsPane: View {
    ...
    var body: some View {
        IceMeltForm {
            IceMeltSection("Menu Bar Sections") {
                enableAlwaysHiddenSection
                showAllSectionsOnUserDrag
                sectionDividerStyle
            }
            IceMeltSection("Other") {
                hideApplicationMenus
                enableSecondaryContextMenu
                showOnHoverDelay
                tempShowInterval
            }
            IceMeltSection("Permissions") {
                allPermissions
            }
        }
    }
    ...
    private var sectionDividerStyle: some View {
        IceMeltPicker("Section divider style", selection: $settings.sectionDividerStyle) {
    ...
    private var hideApplicationMenus: some View {
        ...
        .annotation {
            Text(
                ...
                needed. macOS requires IceMelt to make itself visible in the Dock while \
    ...
    private var enableSecondaryContextMenu: some View {
        ...
        .annotation {
            Text(
                ...
                version of IceMelt's menu. Disable this setting if you encounter conflicts \
                with other apps.
                """
            )
            .padding(.trailing, 75)
